...
export function AbortRebase() {
  return window['go']['main']['App']['AbortRebase']();
}
...
export function Conflicts() {
  return window['go']['main']['App']['Conflicts']();
}

export function ContinueRebase() {
  return window['go']['main']['App']['ContinueRebase']();
}
...
export function RebaseState() {
  return window['go']['main']['App']['RebaseState']();
}
...
export function ResolveOurs(arg1) {
  return window['go']['main']['App']['ResolveOurs'](arg1);
}

export function ResolveTheirs(arg1) {
  return window['go']['main']['App']['ResolveTheirs'](arg1);
}
...
export function WriteResolved(arg1, arg2) {
  return window['go']['main']['App']['WriteResolved'](arg1, arg2);
}
